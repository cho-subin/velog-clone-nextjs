...
- detail
1. 좋아요
2. 작성자 시리즈 포스트 목록 보기 (1차 ui에 연결되어있는 부분이 아니었음)
3. 댓글쓰기
...
2월 16일
[v] redux의 dummydata 제목으로 필터링

2월 17일
[v] write page ui 작업

2월 20일
[v] redux로 댓글 crud중 update기능 구현

2월 21일
[v] component 파일 정리
[v] 좋아요 버튼 작업 (임시 redux로)
[v] 상세페이지 나머지 data 설정 - 작성 날짜(4일전 ,6일 전…), 댓글 수

2월 22일
[v] 마크다운 라이브러리 찾아보기
[v] 마크다운 라이브러리 작성페이지 적용
...
- 리팩토링, 부족한 부분 고치기
- 작성자  포스트 목록 보기 (임시 redux로) 1차 범위에 들어가지 
```
